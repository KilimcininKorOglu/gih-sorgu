...
set GOOS=windows
set GOARCH=amd64
go build -ldflags="-s -w" -o dist\gih-sorgu-windows-amd64.exe .
...
set GOOS=windows
set GOARCH=arm64
go build -ldflags="-s -w" -o dist\gih-sorgu-windows-arm64.exe .
if %errorlevel% neq 0 goto :error
...
set GOOS=linux
set GOARCH=amd64
go build -ldflags="-s -w" -o dist\gih-sorgu-linux-amd64 .
if %errorlevel% neq 0 goto :error
...
set GOOS=linux
set GOARCH=arm64
go build -ldflags="-s -w" -o dist\gih-sorgu-linux-arm64 .
if %errorlevel% neq 0 goto :error
...
set GOOS=darwin
set GOARCH=amd64
go build -ldflags="-s -w" -o dist\gih-sorgu-darwin-amd64 .
if %errorlevel% neq 0 goto :error
...
set GOOS=darwin
set GOARCH=arm64
go build -ldflags="-s -w" -o dist\gih-sorgu-darwin-arm64 .
if %errorlevel% neq 0 goto :error
